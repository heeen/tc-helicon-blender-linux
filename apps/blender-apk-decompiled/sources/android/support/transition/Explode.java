...
public class Explode extends Visibility {
    ...
    private void calculateOut(View view, Rect rect, int[] iArr) {
        ...
        float fCalculateDistance = calculateDistance(fRandom2, fRandom);
        float fCalculateMaxDistance = calculateMaxDistance(view, width - i, iCenterY - i2);
        iArr[0] = Math.round((fRandom2 / fCalculateDistance) * fCalculateMaxDistance);
        iArr[1] = Math.round(fCalculateMaxDistance * (fRandom / fCalculateDistance));
    }
