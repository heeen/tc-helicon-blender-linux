...
public abstract class NotificationExtenderService extends JobIntentService {
    ...
    protected final OSNotificationDisplayedResult displayNotification(OverrideSettings overrideSettings) {
        ...
        NotificationGenerationJob notificationGenerationJobCreateNotifJobFromCurrent = createNotifJobFromCurrent();
        notificationGenerationJobCreateNotifJobFromCurrent.overrideSettings = overrideSettings;
        this.osNotificationDisplayedResult.androidNotificationId = NotificationBundleProcessor.ProcessJobForDisplay(notificationGenerationJobCreateNotifJobFromCurrent);
    ...
    private void processIntent(Intent intent) throws Throwable {
    ...
    void processJsonObject(JSONObject jSONObject, boolean z) throws Throwable {
        boolean zOnNotificationProcessing;
        ...
        try {
            zOnNotificationProcessing = onNotificationProcessing(oSNotificationReceivedResult);
        } catch (Throwable th) {
            ...
            zOnNotificationProcessing = false;
        }
        if (this.osNotificationDisplayedResult == null) {
            if (!zOnNotificationProcessing && NotificationBundleProcessor.shouldDisplay(jSONObject.optString("alert"))) {
