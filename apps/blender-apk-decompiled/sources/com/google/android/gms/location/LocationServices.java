...
public class LocationServices {
    ...
    public static zzchh zzi(GoogleApiClient googleApiClient) {
        ...
        zzbq.zza(zzchhVar != null, "GoogleApiClient is not configured to use the LocationServices.API Api. Pass thisinto GoogleApiClient.Builder#addApi() to use this feature.");
        return zzchhVar;
    }
}
