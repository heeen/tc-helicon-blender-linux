...
public final class zzbhq<I, O> extends zzbgl {
    ...
    zzbhq(int i, int i2, boolean z, int i3, boolean z2, String str, int i4, String str2, zzbhj zzbhjVar) {
        this.zzehz = i;
        this.zzgio = i2;
        this.zzgip = z;
        this.zzgiq = i3;
