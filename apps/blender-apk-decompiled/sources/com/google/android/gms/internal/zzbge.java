...
public final class zzbge extends Drawable implements Drawable.Callback {
    ...
    public final void draw(Canvas canvas) {
        switch (this.zzgdy) {
            ...
            case 2:
                if (this.zzebf >= 0) {
                    float fUptimeMillis = (SystemClock.uptimeMillis() - this.zzebf) / this.zzgeb;
                    z = fUptimeMillis >= 1.0f;
                    if (z) {
                        this.zzgdy = 0;
                    }
                    this.mAlpha = (int) ((this.zzgdz * Math.min(fUptimeMillis, 1.0f)) + 0.0f);
                }
                break;
        }
        int i = this.mAlpha;
    ...
    public final int getChangingConfigurations() {
        return this.zzged.zzgem | super.getChangingConfigurations() | this.zzged.mChangingConfigurations;
    }
